...
async function createDemoAdmin() {
    const email = 'demo_admin@oracle.ai';
    ...
    const { error: credErr } = await supabase.from('credits').insert({
        ...
        description: 'Demo Admin 1M Credits',
        idempotency_key: 'demo_admin_1m_credits_' + Date.now()
    });
    ...
    console.log('Granted 1,000,000 credits.');
