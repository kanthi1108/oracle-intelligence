...
export async function POST(request: Request) {
    try {
        ...
        const reportPayload = {
            ...
            ai_conclusion_text: body.ai_conclusion_text || 'System analysis complete. Expansion parameters aligned.',
            ai_advantages_a: body.ai_advantages_a || {},
            ai_advantages_b: body.ai_advantages_b || {},
            ai_risks_winner: body.ai_risks_winner || {},
            ai_thesis_text: body.ai_thesis_text || 'Market variance computed successfully.',
